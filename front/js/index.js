...
async function main(){// donc on transforme la fonction  en sync    
    const products = await getProducts()//L'opérateur await permet d'attendre la résolution d'une promesse, 
    //il faut l'excuté que dans la fonction en asyncr  donc on transforme la fonction main en sync
